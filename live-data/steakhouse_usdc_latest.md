...
- **Total assets (loan-asset units):** `95,899,725,007,148`
- **Markets:** 8
...
If top-1 depositor(s) exit, demand is 0 vs idle supply 51,074,409,735,803 → 0.0% would be queue-rationed until borrowers repay.
...
```json
{
  ...
  "idle_supply_loan_assets": 51074409735803,
  "rationing_gap": 0,
  "hhi": 0.0
}
```
