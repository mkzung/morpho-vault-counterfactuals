...
- **Total assets (loan-asset units):** `98,075,644,416,281`
- **Markets:** 8
...
| `UtilizationInversion` | `0.125` | fraction_markets_above_target |
...
If top-1 depositor(s) exit, demand is 0 vs idle supply 45,560,015,855,457 → 0.0% would be queue-rationed until borrowers repay.
...
```json
{
  ...
  "idle_supply_loan_assets": 45560015855457,
  "rationing_gap": 0,
  "hhi": 0.0
}
```
...
1 / 8 markets are above the 92% utilization band — IRM curves enter the steep regime; depositor withdrawal pressure compounds.
...
```json
{
  ...
  "breached_markets": [
    {
      "market_id": "0x34377fc4f617c51818e92c79df31ff270c6a91bc94ad32e367fdf59b9f4ac5dd",
      "utilization": 0.9361920141603458
    }
  ]
}
```
