...
- **Total assets:** 68.25M USDC (`68,245,348,888,710` USDC units)
- **Markets:** 11
- **Borrowers analyzed:** 1,000 (largest by debt; API max 1000/query), covering 100.0% of the 476.56M USDC of open debt in the markets this vault lends into.
...
- **HHI (depositor concentration):** `0.222` (top-1 = 43.1%)
...
| `CollateralCascade` | `0.038` | fraction_liquidatable_debt |
...
```json
{
  ...
  "bad_debt_assets": 0,
  "total_debt_assets": 476432507626480,
...
At a -20% collateral shock, 3.8% of debt becomes liquidatable; liquidity gap (debt minus idle supply) is 14,144,224,759,134 loan-asset units across affected markets.
...
{
  "shock_pct": -0.2,
  "liquidatable_debt_assets": 17946457555646,
  "total_debt_assets": 476432507626480,
  "liquidity_gap": 14144224759134,
  "per_market": {
    "0x7e585a933ffe8443c371b4f8cfeb4430f5f6a14c2f32a898c26662c67a1cb8b8": {
      "liquidatable_debt": 5013943923800,
      "available_liquidity": 990584096802,
      "liquidity_gap": 4023359826998
    },
    "0xc498f4bfdda99e60ea8eb04c1e145654a70bc59da76ef9c6ed54a1314d78e5b5": {
      "liquidatable_debt": 11491100709000,
      "available_liquidity": 1370235776864,
      "liquidity_gap": 10120864932136
    },
    "0x3a85e619751152991742810df6ec69ce473daef99e28a64ab2340d7b7ccfee49": {
      "liquidatable_debt": 885401804685,
      "available_liquidity": 16001567623045,
      "liquidity_gap": 0
    },
    "0xb323495f7e4148be5643a4ea4a8221eef163e4bccfdedc2a6f4696baacbc86cc": {
      "liquidatable_debt": 103197482010,
      "available_liquidity": 2758877254721,
      "liquidity_gap": 0
    },
    "0x64d65c9a2d91c36d56fbc42d69e979335320169b3df63bf92789e2c8883fcc64": {
      "liquidatable_debt": 335258506971,
      "available_liquidity": 31994140067092,
      "liquidity_gap": 0
    },
    "0x94b823e6bd8ea533b4e33fbc307faea0b307301bc48763acc4d4aa4def7636cd": {
      "liquidatable_debt": 74513014569,
      "available_liquidity": 561867685384,
      "liquidity_gap": 0
    },
    "0xbc99de6a88904cd0e69042ad6f266e63182801f030c636507c3caf590ffd84fe": {
      "liquidatable_debt": 43042114611,
      "available_liquidity": 57791496765,
      "liquidity_gap": 0
    }
  }
}
...
If top-1 depositor(s) exit, demand is 29,419,507,345,913 vs idle supply 54,248,028,596,681 -> 0.0% would be queue-rationed until borrowers repay.
...
{
  "top_n": 1,
  "exit_demand_loan_assets": 29419507345913,
  "idle_supply_loan_assets": 54248028596681,
  "rationing_gap": 0,
  "hhi": 0.22201115647047687
}
```
...
0.0% of outstanding debt sits within 5 percentage points of LLTV. Top-5% LTV avg: 71.39%. A small adverse oracle move would push this debt into liquidation.

<details><summary>Evidence</summary>

```json
{
  "top_5pct_ltv_avg": 0.7138804295136358,
  "median_ltv": 0.4402669764794669,
  "n_positions": 1000,
  "near_lltv_debt": 0,
  "total_debt_assets": 476432507626480
}
