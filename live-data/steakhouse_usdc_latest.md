...
- **Total assets:** 78.99M USDC (`78,989,730,368,685` USDC units)
- **Markets:** 10
- **Borrowers analyzed:** 1,000 (largest by debt; API max 1000/query), covering 100.0% of the 413.05M USDC of open debt in the markets this vault lends into.
...
- **HHI (depositor concentration):** `0.228` (top-1 = 43.6%)
...
| `CollateralCascade` | `0.062` | fraction_liquidatable_debt |
...
```json
{
  ...
  "bad_debt_assets": 20005774126,
  "total_debt_assets": 412982465878913,
...
At a -20% collateral shock, 6.2% of debt becomes liquidatable; liquidity gap (debt minus idle supply) is 11,345,352,901,363 loan-asset units across affected markets.
...
{
  "shock_pct": -0.2,
  "liquidatable_debt_assets": 25466048908493,
  "total_debt_assets": 412982465878913,
  "liquidity_gap": 11345352901363,
  "per_market": {
    "0x3a85e619751152991742810df6ec69ce473daef99e28a64ab2340d7b7ccfee49": {
      "liquidatable_debt": 17028890775999,
      "available_liquidity": 10839162098397,
      "liquidity_gap": 6189728677602
    },
    "0xc498f4bfdda99e60ea8eb04c1e145654a70bc59da76ef9c6ed54a1314d78e5b5": {
      "liquidatable_debt": 4982728055592,
      "available_liquidity": 516826694286,
      "liquidity_gap": 4465901361306
    },
    "0x7e585a933ffe8443c371b4f8cfeb4430f5f6a14c2f32a898c26662c67a1cb8b8": {
      "liquidatable_debt": 1392141029201,
      "available_liquidity": 723370615971,
      "liquidity_gap": 668770413230
    },
    "0x64d65c9a2d91c36d56fbc42d69e979335320169b3df63bf92789e2c8883fcc64": {
      "liquidatable_debt": 1512839658141,
      "available_liquidity": 26651605115489,
      "liquidity_gap": 0
    },
    "0xb323495f7e4148be5643a4ea4a8221eef163e4bccfdedc2a6f4696baacbc86cc": {
      "liquidatable_debt": 520487805190,
      "available_liquidity": 2410090435433,
      "liquidity_gap": 0
    },
    "0xbc99de6a88904cd0e69042ad6f266e63182801f030c636507c3caf590ffd84fe": {
      "liquidatable_debt": 28961584370,
      "available_liquidity": 8009135145,
      "liquidity_gap": 20952449225
    }
  }
}
```
...
If top-1 depositor(s) exit, demand is 34,403,208,131,081 vs idle supply 42,352,164,631,035 -> 0.0% would be queue-rationed until borrowers repay.
...
{
  "top_n": 1,
  "exit_demand_loan_assets": 34403208131081,
  "idle_supply_loan_assets": 42352164631035,
  "rationing_gap": 0,
  "hhi": 0.22829617403211536
}
```
...
0.0% of outstanding debt sits within 5 percentage points of LLTV. Top-5% LTV avg: 73.78%. A small adverse oracle move would push this debt into liquidation.

<details><summary>Evidence</summary>

```json
{
  "top_5pct_ltv_avg": 0.7377807463055308,
  "median_ltv": 0.505865606522585,
  "n_positions": 1000,
  "near_lltv_debt": 0,
  "total_debt_assets": 412982465878913
}
