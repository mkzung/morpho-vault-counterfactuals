...
- **Total assets (loan-asset units):** `95,987,098,308,381`
- **Markets:** 8
...
If top-1 depositor(s) exit, demand is 0 vs idle supply 50,128,234,182,118 → 0.0% would be queue-rationed until borrowers repay.
...
```json
{
  ...
  "idle_supply_loan_assets": 50128234182118,
  "rationing_gap": 0,
  "hhi": 0.0
}
```
