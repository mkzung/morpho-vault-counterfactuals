...
- **Total assets (loan-asset units):** `94,476,758,853,872`
- **Markets:** 8
...
If top-1 depositor(s) exit, demand is 0 vs idle supply 64,015,922,454,719 → 0.0% would be queue-rationed until borrowers repay.
...
```json
{
  ...
  "idle_supply_loan_assets": 64015922454719,
  "rationing_gap": 0,
  "hhi": 0.0
}
```
